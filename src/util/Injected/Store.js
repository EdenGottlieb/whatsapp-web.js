...
exports.ExposeStore = () => {
    ...
    window.Store.MediaUpload = {
        ...window.safeRequire('WAWebMediaMmsV4Upload'),
        ...window.safeRequire('WAWebStartMediaUploadQpl')
    };
    window.Store.MediaUpdate = window.safeRequire('WAWebMediaUpdateMsg');
    ...
    window.Store.Settings = {
        ...
        setPushname: window.safeRequire('WAWebSetPushnameConnAction').setPushname
    };
    window.Store.NumberInfo = {
        ...window.safeRequire('WAWebPhoneUtils'),
