...
exports.ExposeStore = () => {
    ...
    if (!window.Store.Call)
        window.Store.Call = window.Store.WAWebCallCollection;
    if (!window.Store.ChatPreference)
        window.Store.ChatPreference =
            window.Store.WAWebChatPreferenceCollection;
    if (!window.Store.ConversionTuple)
        window.Store.ConversionTuple =
            window.Store.WAWebConversionTupleCollection;
    if (!window.Store.GroupMetadata)
        window.Store.GroupMetadata = window.Store.WAWebGroupMetadataCollection;
    if (!window.Store.UnjoinedSubgroupMetadataCollection)
        window.Store.UnjoinedSubgroupMetadataCollection =
            window.Store.WAWebUnjoinedSubgroupMetadataCollection;
    if (!window.Store.CommunityActivityCollection)
        window.Store.CommunityActivityCollection =
            window.Store.WAWebCommunityActivityCollection;
    if (!window.Store.NewsletterCollection)
        window.Store.NewsletterCollection =
            window.Store.WAWebNewsletterCollection;
